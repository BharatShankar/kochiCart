class FoodItemsModel {
  ...
  FoodItemsModel.fromJson(Map<String, dynamic> json) {
...
class CategoryDishes {
  ...
  CategoryDishes(
      ...
      this.addonCat,
      this.count,
      this.dishTotalItemsPrice});

  CategoryDishes.fromJson(Map<String, dynamic> json) {
    dishId = json['dish_id'] ?? "N/A";
    dishName = json['dish_name'] ?? "N/A";
    testValue = json['dish_price'];
    dishPrice = json['dish_price'].toInt();
    dishImage = json['dish_image'] ?? "N/A";
    dishCurrency = json['dish_currency'] ?? "N/A";
    dishCalories = json['dish_calories'].toInt() ?? 0;
    dishDescription = json['dish_description'] ?? "N/A";
    dishAvailability = json['dish_Availability'] ?? false;
    dishType = json['dish_Type'] ?? 0;
    nexturl = json['nexturl'];
    count = 0;
    dishTotalItemsPrice = 0;
  ...
  // double get convertIntToDouble {
  //   return testValue *
  // }

  // dynamic get getEachDishPriceForCount {
  //   return count * dishPrice;
  // }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['nexturl'] = this.nexturl ?? "N/A";
    count = this.count;
    dishTotalItemsPrice = this.dishTotalItemsPrice;
